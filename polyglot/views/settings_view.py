...
class SettingsView(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.words_per_day_entry = ctk.CTkEntry(
            self.words_per_day_frame,
            width=100,
            textvariable=self.words_per_day_var
        )
        ...
        self.flashcard_delay_entry = ctk.CTkEntry(
            self.flashcard_delay_frame,
            width=100,
            textvariable=self.flashcard_delay_var
        )
        ...
        self.test_word_count_entry = ctk.CTkEntry(
            self.test_word_count_frame,
            width=100,
            textvariable=self.test_word_count_var
        )
